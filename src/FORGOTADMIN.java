...
public class FORGOTADMIN extends javax.swing.JFrame {
    ...
    /**
     * Creates new form FORGOTADMIN
     */
    public FORGOTADMIN() {
        initComponents();
    }
     public FORGOTADMIN(String us){
         initComponents();
         user.setText(us);
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
           ...
           Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/hitachi?zeroDateTimeBehavior=convertToNull", "root", "");
            String sql = "Select * from admin where Admin_id=? and Hobby=?";
            ...
            if(rs.next()){
                new ADMINOTP(us).setVisible(true);
                dispose();
